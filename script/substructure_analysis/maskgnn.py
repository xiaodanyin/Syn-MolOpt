...
class EarlyStopping(object):
    ...
    def __init__(self, pretrained_model='Null_early_stop.pth', mode='higher', patience=10, filename=None,
        ...
        if filename is None:
            task_name = task_name
            filename = '../../outputs/substructure_analysis/trained_models/{}_early_stop.pth'.format(task_name)
        former_filename = '../../outputs/substructure_analysis/trained_models/{}_early_stop.pth'.format(former_task_name)
